...
<section id="ourSolutions" class=" contentBlockPart"  style="min-height:999px;">
  ...
  <div class="col-sm-6">
    <div class="container posRelative">
    <div class="inner-box"><div class="img"><img data-cke-saved-src="https://www.egurutam.com/c_it/assets/skill.png" src="https://www.egurutam.com/c_it/assets/skill.png" style="width:15%;"></div>
  </div>
      <h2 class="mrgB15"><span>Soft Skills</span></h2>
      <span class="tagspan">In today's competitive world, soft skills are very crucial for career building and success. At Gurutam, we provide world class professional training in following areas:</span><br/><br/>
      
      
    </div>
     </div>
   <div class="col-sm-6" style="float:right;"><img class="side-image" data-cke-saved-src="https://www.egurutam.com/c_it/assets/5484597.jpg" src="https://www.egurutam.com/c_it/assets/5484597.jpg" style="width:64%;"></div>
...
<li>  Hapiness curriculum</li>
<li>  Fundamental and advanced Communication skills</li>
            </ul>
            <br/><br/>
            
            <p>Our delivery methodology include case studies and sharing the real life situations. </p><br/>
